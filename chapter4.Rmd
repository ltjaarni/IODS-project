...
We have seem to have quite good classification performance: with the correct predictions found on the diagonal, we have a sum total of 64, which comes down to an accuracy of $64/102\sim=0.628$.With a balanced baseline, so that all classes are of the same size, without our predictors and our model, we would have an accuracy of $0.25$. Compared to that our model classifies very well.
